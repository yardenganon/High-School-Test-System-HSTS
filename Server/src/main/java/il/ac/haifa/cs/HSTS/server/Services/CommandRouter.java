...
public class CommandRouter {
    ...
    public void initRouter(List<ControllerInterface> controllers){
        ...
        commandsMap.put(TestFacadeReadAllByTeacherCommand.class.getSimpleName(), controllers.get(2));
        ...
        commandsMap.put(AnswerableTestsFacadeReadByTeacherCommand.class.getSimpleName(), controllers.get(2));
